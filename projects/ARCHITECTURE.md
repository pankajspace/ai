...
6. **Easy to add projects** — copy the `template` project (a ready-made Flask + Docker starter); a new app project = new Docker Compose service + new Nginx `location` block
