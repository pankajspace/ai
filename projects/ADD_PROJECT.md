...
1. Local development port: `8087`.
2. EC2 host port: `5007`.
...
4. If the project should appear in the public catalog or home page, update `projects/techtoday/study/ai-projects.html` (and optionally `projects/techtoday/index.html`).

Public project catalog card update:

1. Open `projects/techtoday/study/ai-projects.html`.
...
7. Preview `projects/techtoday/index.html` and `projects/techtoday/study/ai-projects.html` locally before committing.
