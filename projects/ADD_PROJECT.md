...
4. If the project should appear in the public catalog or home page, update `projects/techtoday/ai-projects.html` (and optionally `projects/techtoday/index.html`).

Public project catalog card update:

1. Open `projects/techtoday/ai-projects.html`.
...
7. Preview `projects/techtoday/index.html` and `projects/techtoday/ai-projects.html` locally before committing.
